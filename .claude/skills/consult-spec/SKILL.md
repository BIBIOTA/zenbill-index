...
### Phase 1 技術文件
- **Technical Architecture**: `backend/phase-1/1.technical-architecture.md`
- **Database Schema**: `backend/phase-1/2.database-schema.puml`
- **Backend Architecture**: `backend/phase-1/3.backend-architecture.puml`
- **Todo List**: `backend/phase-1/4.todo-list.md`
- **Test Cases**: `backend/phase-1/5.test-cases.md`
